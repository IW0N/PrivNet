...
namespace Common.Extensions
{
    public static class CryptoExtension
    {
        ...
        public static T DecryptObject<T>(this byte[] encrypted, AesKey key) => encrypted.DecryptObject<T>(key, Encoding.UTF8);
        ...
        //public static byte[] EncryptUtf8(this string text, AesKey key) => Encrypt(text, key, Encoding.UTF8);
        ...
        public static byte[] EncryptObject<T>(this T obj, AesKey key) => obj.EncryptObject(key, Encoding.UTF8);
    }
}
